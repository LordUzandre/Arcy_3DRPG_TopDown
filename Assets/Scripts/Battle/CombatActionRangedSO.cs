...
{
    [CreateAssetMenu(fileName = "Ranged Combat Action", menuName = "Arcy/Battle/Combat Actions/Ranged Combat Action SO")]
    public class CombatActionRangedSO : CombatActionBase
    {
